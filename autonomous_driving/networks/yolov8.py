...
if __name__=='__main__':
    model = YOLOv8Model(model_type='n')
    # model.load_state_dict(torch.load("../weights/yolov8/yolov8n.pt", map_location='cpu'))
    # model.eval()
    # image_path = f"/Users/aristotelistsoytsanis/Downloads/Mac/Train/Data/Dataset1/IMG/CapturedImage100.jpg"
